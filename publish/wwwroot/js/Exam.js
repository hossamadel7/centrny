(function initExamPage(factory) {
    if (typeof window.jQuery !== 'undefined') {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            if (typeof window.jQuery !== 'undefined') {
                ...
                console.error('Exam.js requires jQuery. Please include jQuery before this script.');
            }
        });
    }
})(function ($) {
    ...
    // Safe hide helper for Bootstrap 4/5
    ...
    `);
        ...
        $('#questionsForm').on('submit', function (e) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.success) {
                        // Close modal safely across Bootstrap versions
                        safeHideModalById('questionsModal');
                        loadExams();
